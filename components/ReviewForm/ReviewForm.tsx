...
export const ReviewForm = ({
  ...
  const onSubmite = async (formData: IReviewForm) => {
    try {
      const { data } = await axios.post<IReviewSentResponse>(API.review.crateDemo, {
        ...formData,
        productId,
      });
      if (data.message) {
    ...
    <form onSubmit={handleSubmit(onSubmite)}>
      <div className={cn(styles.reviewForm, className)} {...props}>
        ...
        <div className={styles.submit}>
          <Button tabIndex={tabIndex} appearance="primary">
            Отправить
          </Button>
